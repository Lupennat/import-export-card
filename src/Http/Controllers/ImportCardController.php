...
use Lupennat\ImportExportCard\BasicImporter;
use Laravel\Nova\Actions\Action;
use Laravel\Nova\Http\Requests\NovaRequest;
use Laravel\Nova\Rules\Relatable;
use Lupennat\ImportExportCard\ImportException;
...
class ImportCardController
{
    public function handle(NovaRequest $request)
    {
        ...
        $importerClass = $resource::$importer ?? BasicImporter::class;
    ...
    {
        throw ValidationException::withMessages([0 => [$error]]);
    }
}
